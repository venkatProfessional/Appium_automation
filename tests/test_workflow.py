...
@pytest.mark.order(1)
def test_login_negative_cases(driver):
    try:
        login_page = LoginPage(driver)
        login_page.test_login_negative_cases()
    except Exception as e:
        print(f"❌ test_login_negative_cases failed: {e}")
    time.sleep(5)
...
def test_login_valid(logged_in_driver):
    try:
        ...
        print(f"❌ test_login_valid failed: {e}")
    time.sleep(5)
...
def test_projects_page_valid(logged_in_driver):
    try:
        ...
        project_page.click_save_button()
        project_page.click_fetch_location()
        project_page.allow_location_popup()
        project_page.wait_for_location_and_click_save()
        ...
        print(f"❌ test_projects_page_valid failed: {e}")
    time.sleep(5)
...
def test_approve_reject_leave_flow(logged_in_driver):
    try:
        ...
        print(f"❌ test_approve_reject_leave_flow failed: {e}")
    time.sleep(5)
...
def test_approve_permission_flow(logged_in_driver):
    try:
        ...
        print(f"❌ test_approve_permission_flow failed: {e}")
    time.sleep(5)
...
def test_resignation_maintenance_filters(logged_in_driver):
    try:
        ...
        print(f"❌ test_resignation_maintenance_filters failed: {e}")
    time.sleep(5)
...
def test_feedback_cards_navigation(logged_in_driver):
    try:
        ...
        feedback_page.click_toggle_menu()
        feedback_page.click_feedback_menu()
        feedback_page.open_and_close_feedback_cards(2)
    except Exception as e:
        print(f"❌ test_feedback_cards_navigation failed: {e}")
    time.sleep(5)
...
def test_repair_maintenance_navigation(logged_in_driver):
    try:
        ...
        print(f"❌ test_repair_maintenance_navigation failed: {e}")
    time.sleep(5)
...
def test_notification_maintenance_navigation(logged_in_driver):
    try:
        ...
        print(f"❌ test_notification_maintenance_navigation failed: {e}")
    time.sleep(5)
...
def test_attendance_flow(logged_in_driver):
    try:
        ...
        print(f"❌ test_attendance_flow failed: {e}")
    time.sleep(5)
...
def test_logout_flow(logged_in_driver):
    try:
        ...
        print(f"❌ test_logout_flow failed: {e}")
    time.sleep(5)
...
def test_forgot_password_flow(driver):
    try:
        ...
        print(f"❌ test_forgot_password_flow failed: {e}")
    time.sleep(5)
